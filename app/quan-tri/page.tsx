...
<div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
  ...
  <input
   ...
   placeholder="Tìm theo tên, số điện thoại, nhu cầu gợi mở, ngày sinh, giờ sinh, điều đang trăn trở..."
    ...
    {duLieuDaLoc.map((dong) => (
      ...
      >
        ...
        <div className="mt-4 grid gap-2 text-sm text-slate-200">
          <p><b className="text-yellow-300">Nhu cầu gợi mở:</b> {dong.nhu_cau || dong.mong_muon || "-"}</p>
          <p><b className="text-yellow-300">Ngày sinh:</b> {dong.ngay_sinh || "-"}</p>
          <p><b className="text-yellow-300">Giờ sinh:</b> {dong.gio_sinh || "-"}</p>
                    <p><b className="text-yellow-300">Điều đang trăn trở:</b> {dong.ghi_chu_dac_biet || "-"}</p>
        </div>
